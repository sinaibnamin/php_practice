...
if (!isset($_SESSION['user_id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Ensure feedback is not empty before proceeding
        if (!empty($feedback)) {
           
            include 'utils.php'; 
            $db = new SQLite3('data/users.db');

            $stmt = $db->prepare("INSERT INTO feedback (user_id, feedback) VALUES (:user_id, :feedback)");
            ...
            echo "<p class='text-red-600'>Feedback cannot be empty.</p>";
        }
    }
    ?>
