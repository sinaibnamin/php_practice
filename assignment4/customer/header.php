...
$customer_session_info = $customer->get_customer_session_info();

// $customer_current_balance = $customer->currentBalance();
              ...
              <div class="flex items-center px-2 lg:px-0">
                <div class="hidden sm:block">
                  <div class="flex space-x-4">
                    <?php 
                    $header_menu_active_class = "bg-emerald-700 text-white rounded-md py-2 px-3 text-sm font-medium";
                    $header_menu_inactive_class = "text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium"
                    ?>
                    <a
                      href="./dashboard.php"
                      class="<?= 
