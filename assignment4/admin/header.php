              ...
              <div class="flex items-center px-2 lg:px-0">
                <div class="hidden sm:block">
                  <div class="flex space-x-4">
                    <?php 
                    $header_menu_active_class = "bg-sky-700 text-white rounded-md py-2 px-3 text-sm font-medium";
                    $header_menu_inactive_class = "text-white hover:bg-sky-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium"
                    ?>
